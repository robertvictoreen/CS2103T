...
=== Adding a profile picture : 'addpicture'

Adds a profile picture to a student +
...
* `addpicture 1 f/C://Users/Zackk95/Pictures/zacharytan.jpg` +
Edits the profile picture of the 1st person to be the picture at C://Users//Zackk95//Pictures//zacharytan.jpg
...
=== Deleting a student's photo: `deleteProfilePicture INDEX`

Delete a student's photo and sets it to the default picture. +
Format: `deleteProfilePicture INDEX`

****
* Will delete a student's picture and set it to the default picture.
* This command is irreversible!
****

Examples:

* `deleteProfilePicture 1` +
Delete the picture of the person at index 1 and set it to the default picture.
...
[NOTE]
====
Undoable commands: those commands that modify the student list's content (`add`, `delete`, `edit`, `markAssignment`, `markAttendance`, `sort` and `clear`).
====
...
=== Mark a student's attendance as present or absent: `markAttendance`
...
[TIP]
Editing a note of a student who currently has none is the same as adding a note to him/her.

Examples:

* `editnote 1 check finals mark addition`
(Even if the student at index 1 did not have a note, it would be added and the resulting note would be `check finals mark addition.` +

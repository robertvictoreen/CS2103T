...
+
image::userGuide_noteExample.png[width="300"]
+
`note 1 motivated too!` +
Student at 1st index's note:
+
image::userGuide_noteExample2.png[width="300]
...
+
image::userGuide_editnoteExample.png[width="300]
+
`note 2 check midterms also?` +
Student at 2nd index's note:
+
image::userGuide_editnoteExample2.png[width="300]
+
`editnote 2 marks checked.` +
Student at 2nd index's note:
+
image::userGuide_editnoteExample3.png[width="300]
+
`delnote 2` +
Student at 2nd index's note:
+
image::userGuide_editnoteExample4.png[width="300]
// end::note[]

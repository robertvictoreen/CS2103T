...
Displays the number of submissions and the highest, lowest, 25th/75th percentiles, average, and median of the marks for the specified assignment. +
...
Displays the number of students and the highest, lowest, 25th/75th percentiles, average, and median of the students' total grades. +
Format: `classStats`

...
*** Modified tests for existing features to ensure accuracy with changes in functionality (Pull requests https://github.com[#36], https://github.com[#38])
** Community:
...
*** Contributed to bug fixes (https://github.com/CS2103-AY1819S1-W12-4/main/pull/104[#104])

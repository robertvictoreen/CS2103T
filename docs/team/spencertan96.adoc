...
* Code contributed: [https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=spencertan96[Project Code Dashboard]]

* *Other contributions*:

** Project management:
*** Managed releases `v1.1` and `v1.3` to `v1.3.4` (6 releases) on GitHub
** Enhancements to existing features:
*** Changed the "add" command to only have a person's name as a compulsory parameter, with the rest being optional. It also takes in an additional index argument that adds the person at that specified index. (Pull request https://github.com/CS2103-AY1819S1-W12-4/main/pull/103[#103])
** Documentation:
*** Update GitHubPages and README to reflect the product and the team details: https://github.com[#14]

...
* 3b. Tutor doesn’t want to check attendance anymore, he wants to exit.
** 3b1. EazyTutors exits the prompt for new data.
** 3b2. Tutor is back at main menu.
+
Use case ends.
...
** 3a1. EazyTutors requests for correct data.
** 3a2. User enters new data.
* 3b. Tutor doesn’t want to check assignment submissions anymore, he wants to exit.
** 3b1. EazyTutors exits the prompt for new data.
** 3b2. Tutor is back at main menu.
+
Use case ends.

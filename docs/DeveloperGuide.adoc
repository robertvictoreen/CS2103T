...
The following sequence diagram shows how the `deletephoto` command works
...
image::DeleteProfilePhotoUMLSequenceDiagram.png[width="800"]
    ...
    2. The `AddressBookParser` class parses the command and create a new `DeleteProfilePhotoCommand` class.

...
* **Alternative 1 (current choice):** Only sorts by names of students in the Address Book.
**Pros:** Easy to implement and more intuitive for the user.
**Cons:** Functionality is limited and may not improve user satisfaction.
...
**Pros:** Improved flexibility for users since they have the option to sort by any field that they want.
**Cons:** Harder to implement and requires constant updating of code every time a new field in the 'Person' class is introduced.
//end:sort[]

...
public class AddPictureCommandTest {
    ...
    public void execute_validFilepathUnfilteredList_success() throws Exception {
        ...
        updatedPerson.setProfilePicture(VALID_LOCAL_IMAGE_JPG);
        AddProfilePictureCommand addPictureCommand = prepareCommand(index, VALID_LOCAL_IMAGE_JPG);
        String expectedMessage = String.format(AddProfilePictureCommand.MESSAGE_EDIT_PERSON_SUCCESS, index.getOneBased());
        Model expectedModel =
    ...
    public void execute_filteredListInvalidIndex_failure() throws Exception {
        ...
        AddProfilePictureCommand addPictureCommand = prepareCommand(outOfBoundIndex, VALID_LOCAL_IMAGE_JPG);
    ...
    public void equals() throws Exception {
        AddProfilePictureCommand addPicCommandFirst = prepareCommand(INDEX_FIRST_PERSON, VALID_LOCAL_IMAGE_JPG);
        AddProfilePictureCommand addPicCommandSecond = prepareCommand(INDEX_SECOND_PERSON, VALID_LOCAL_IMAGE_PNG);

        // same object -> returns true
        assertTrue(addPicCommandFirst.equals(addPicCommandFirst));

        // same values -> returns true
        AddProfilePictureCommand addPicCommandFirstCopy = prepareCommand(INDEX_FIRST_PERSON, VALID_LOCAL_IMAGE_JPG);
        ...
        AddProfilePictureCommand apc = prepareCommand(INDEX_SECOND_PERSON, VALID_LOCAL_IMAGE_JPG);
     ...
     */
    private AddProfilePictureCommand prepareCommand(Index index, String path) {
        AddProfilePictureCommand addPictureCommand = new AddProfilePictureCommand(index, path);

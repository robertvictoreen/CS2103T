...
public class DeleteProfilePhotoCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteProfilePhotoCommand.MESSAGE_USAGE);

    private DeleteProfilePhotoCommandParser parser = new DeleteProfilePhotoCommandParser();

    @Test
    public void parse_validArgs_returnsResetPictureCommand() {
        assertParseSuccess(parser, "1", new DeleteProfilePhotoCommand(INDEX_FIRST_PERSON));
    }

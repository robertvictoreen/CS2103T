...
public class MoreDetailsPanelTest extends GuiUnitTest {
    private PersonPanelSelectionChangedEvent selectionChangedEventStub;

    private MoreDetailsPanelHandle browserPanelHandle;

    @Before
    public void setUp() {
        selectionChangedEventStub = new PersonPanelSelectionChangedEvent(ALICE);

        guiRobot.interact(() -> detailsPanel = new MoreDetailsPanel());
        uiPartRule.setUiPart(detailsPanel);

        browserPanelHandle = new MoreDetailsPanelHandle(detailsPanel.getRoot());
    }
